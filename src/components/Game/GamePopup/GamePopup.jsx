...
function GamePopup(props) {
  return (
    <>
      ...
      ></div> */}
      <div
        className="popup open col-8 position-absolute top-50 start-50 translate-middle 
      ...
      >
        ...
        <div className="row fs-4">รอบที่ใช้ 1/10</div>

        <div className="row fs-4 pt-3">คำตอบคือ</div>
        <div className="answer row fw-bolder pb-4">{props.num}</div>
